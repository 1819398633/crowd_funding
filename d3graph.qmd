...
<div id="charts" style="padding-left: 30px;">
  ...
  <input type="radio" name="chart_type" value="proportions" checked = True>Proportions</input>
  ...
  <input type="radio" name="order" value="success_rate" checked = True>Success Rate</input>
