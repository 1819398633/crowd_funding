...
Second, we find that the missing of `# Videos`, `# Words (Risks and Challenges)` will appears together with the missing of \`Creator Website\`, `Latitude`, and `Longitude`. Such cases are rare, and the end time of the projects only appears from January, 2014 to March, 2014. We checked the crowd funding webpages and found the data are accessible. Therefore, manually error or technical issue in data collecting may be the reason.
