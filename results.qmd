...
## How long is the Risks and Challenges section for successful vs. failed projects? 
...
When comparing the number of words in the Risks and Challenges section between successful and failed projects, we can see that the medians appear to be fairly similar. However, we noticed that there were more higher outlier values among failed projects than successful projects. To confirm our observations, we plotted a bar chart of the number of successful and failed projects that have greater than 500 words in the Risks and Challenges section. There are indeed twice as many projects that failed than there were projects that were successful. More words in the Risks and Challenges section could indicate that the project itself has more risks and challenges associated with it, which may discourage potential backers from supporting the project. 
